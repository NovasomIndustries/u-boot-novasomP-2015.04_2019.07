cmd_spl/board/novasomp/novasomp.o := arm-buildroot-linux-gnueabihf-gcc -Wp,-MD,spl/board/novasomp/.novasomp.o.d  -nostdinc -isystem /Devel/NOVAsdk2019.01/Xcompiler_2019.01/arch32-arm-gcc-5.5.0/bin/../lib/gcc/arm-buildroot-linux-gnueabihf/5.5.0/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x17800000 -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(novasomp)"  -D"KBUILD_MODNAME=KBUILD_STR(novasomp)" -c -o spl/board/novasomp/novasomp.o board/novasomp/novasomp.c

source_spl/board/novasomp/novasomp.o := board/novasomp/novasomp.c

deps_spl/board/novasomp/novasomp.o := \
...
spl/board/novasomp/novasomp.o: $(deps_spl/board/novasomp/novasomp.o)
